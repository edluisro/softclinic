...
<head>
    ...
    <title>Olvidé mi contraseña - <?php echo $this->db->get('settings')->row()->system_vendor; ?></title>
    <!-- Bootstrap core CSS -->
    ...
    <div class="container">
        ...
        <div class="form-signin">
            ...
            <div class="login-wrap">
                <p>
                    <label for="identity"><?php echo ((isset($type) == 'email') ? sprintf(lang('forgot_password_email_label'), $identity_label) : sprintf(lang('forgot_password_identity_label'), $identity_label)); ?></label> <br />
